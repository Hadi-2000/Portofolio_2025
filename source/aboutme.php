      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <p class="text-justify m-5">
            Fresh graduate Sarjana Informatika dari STMIK AMIKOM Surakarta. Memiliki pengalaman dalam pengembangan aplikasi web, dan pengelolaan database. Mahir menggunakan alat seperti Visual Studio Code, dan XAMPP. Memiliki pengalaman dalam melakukan pengelolaan keuangan usaha keluarga. Berorientasi pada hasil, cepat belajar, dan siap menghadapi tantangan serta beradaptasi dengan teknologi baru. 
          </p>
        </div>
      </div>
